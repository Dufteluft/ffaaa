...
function EndGame(lobbyId, reason)
    ...
    if lobby.isPersistent then
        Citizen.CreateThread(function()
            Citizen.Wait(10000) -- Result time
...
AddEventHandler('ffa:voteMap', function(data)
    ...
    if state and state.lobbyId then
        ...
        if lobby and lobby.isPersistent then
            -- For persistent lobbies, we just log the vote or change for next round
            -- Simple implementation: last vote wins for the next transition
