...
Lobbies = {}
PlayerStates = {}
TeamAssignments = {} -- Persistent team tracking
...
function JoinLobby(playerId, lobbyId)
    ...
    PlayerStates[playerId] = {
        lobbyId = lobbyId,
        team = TeamAssignments[playerId] or 'none',
    ...
    -- Synchronize existing settings to the new player
    TriggerClientEvent('ffa:syncSettings', playerId, lobby)
