...
-- Hilfsfunktion für Lokalisierung auf Server-Seite
...
-- Funktion: Aktualisiert Spielerliste
...
-- Event: Host Einstellungen speichern
...
-- Automatisches Löschen leerer Custom Lobbys
