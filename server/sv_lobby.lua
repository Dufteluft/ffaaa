...
AddEventHandler('ffa:updateSettings', function(settings)
    ...
    -- Clients über neue Settings informieren (für UI Summary)
...
-- Automatische Initialisierung der persistenten Lobbies
Citizen.CreateThread(function()
    ...
    for _, map in ipairs(Config.Maps) do
        ...
        -- Persistente Lobbies direkt auf playing setzen
        for id, lobby in pairs(Lobbies) do
