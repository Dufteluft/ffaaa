...
Config.Locales = {
    ...
    ['en'] = {
        ...
        ['kd_ratio'] = 'K/D',
        ['score'] = 'Score',
        ['notif_leave_zone'] = 'You are leaving the combat zone!',
        ['notif_weapon_not_allowed'] = 'This weapon is not allowed here!',
        ['notif_kicked'] = 'You have been kicked from the lobby.',
        ['system_msg'] = 'SYSTEM'
    }
}
