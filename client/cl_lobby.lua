...
-- Menü-Steuerung (RegisterKeyMapping für benutzerdefinierte Tasten)
...
RegisterNetEvent('ffa:lobbyUpdated')
AddEventHandler('ffa:lobbyUpdated', function(lobby)
    currentLobby = lobby
    SendNUIMessage({
        action = 'lobbyJoined', -- Re-use logic to refresh settings display
        lobby = lobby
    })
end)
