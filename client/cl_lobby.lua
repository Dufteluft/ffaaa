...
-- Menü-Steuerung via KeyMapping (erlaubt Spielern das Umbelegen in den GTA-Einstellungen)
RegisterKeyMapping('ffa_menu', 'FFA Lobby System öffnen', 'keyboard', Config.MenuKey)
