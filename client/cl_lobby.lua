...
-- Menü-Steuerung via RegisterKeyMapping (ermöglicht Rebinding in GTA Einstellungen)
RegisterKeyMapping('openffamenu', 'FFA Lobby Menu öffnen', 'keyboard', Config.MenuKey)
