...
-- Menü-Steuerung via RegisterKeyMapping (ermöglicht Rebinding in den GTA Einstellungen)
RegisterKeyMapping('openffa', 'FFA Lobby Menü öffnen', 'keyboard', Config.MenuKey)
